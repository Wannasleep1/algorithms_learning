...
class MCState:
    ...
    def __init__(self, missionaries: int, cannibals: int,
                 boat: bool) -> None:
        # миссионеры с западного берега
        self.wm: int = missionaries
        # людоеды с западного берега
        self.wc: int = cannibals
        # миссионеры с восточного берега
        self.em: int = MAX_NUM - self.wm
        # людоеды с восточного берега
